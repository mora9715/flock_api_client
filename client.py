...
class PatchedClient(Client):
    ...
    def __init__(self,
                 ...
                 timeout=None,
                 token=None):
        # Rewriting __init__ method to store token
        self.host = host
    ...
    def _build_url(self, query_params):
        # rewriting the method to delimit parts with . but now with /
        url = ''
        count = 0
...
class FlockAPIClient:
    def __init__(self, token, timeout=10, endpoint='api.flock.co', port=443, protocol='https', version=1):
